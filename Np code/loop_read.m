function [] = loop_read(J_l,Gamma_l,V_l,mask_l,J_p,Gamma_p,V_p,mask_p,NNp)
...
name=strcat('/delay',num2str(tau0),'_Np_',num2str(Np),'_Omega',num2str(Omega),'omega0',num2str(omega0),'eps',num2str(Eps),'dim',num2str(dim),'d',num2str(d),'kappa',num2str(kappa),'J',num2str(J0),'alpha',num2str(Alpha),'N',num2str(N),'Ntr',num2str(Ntrc),'dt',num2str(dt),'gamma_d',num2str(gamma_d),'gamma_u',num2str(gamma_u));
